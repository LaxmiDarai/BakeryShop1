...
<body class="fix-header">
    ...
    <div class="form-group has-danger">
        ...
        <input type="text" name="url" class="form-control form-control-danger" id="url-input">
        <div id="url-error" style="color: red;"></div>
					...
					<footer class="footer"> © 2023 - Bakery Management System </footer>
                </div>               
            </div>          
        </div>
    </div>
    ...
    function isValidUrl(url) {
        const regex = /^(http(s)?:\/\/)?(www\.)?([a-zA-Z0-9_-]+\.)+[a-zA-Z]{2,6}(\/[a-zA-Z0-9#]+\/?)*$/;
