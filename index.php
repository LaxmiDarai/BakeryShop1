...
<body class="home">
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/tick.png" alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/bg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Bake Shop</h4> </div>               
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order it</h4> </div>             
                ...
                <div class="title text-xs-center m-b-30">
                    <h2><span style="color:white;">Choose or give us a design to make a delicious cake</span></h2>
                    <p class="lead"><span style="color:white;">Easiest way to order your favourite cake among these item</span></p>
                </div>         
                </div>
            </div>     
        </section>
    ...
    <!--<script src="https://kit.fontawesome.com/eeb2d98d67.js" crossorigin="anonymous"></script>-->
